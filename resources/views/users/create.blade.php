    ...
    <div class="bg-white border-bottom shadow-sm">
        <div class="container-fluid py-4 d-flex flex-column flex-lg-row align-items-lg-center justify-content-between gap-3">
            <div>
                ...
                <h2 class="h2 fw-semibold text-dark mt-2 mb-1">Tambah Pengguna Baru</h2>
                <p class="text-muted mb-0">Isi formulir berikut untuk membuat akun.</p>
            </div>
                        ...
                        <form action="{{ route('users.store') }}" method="POST" class="d-flex flex-column gap-4">
                            ...
                            <div>
                                ...
                                <input type="text" id="name" name="name" value="{{ old('name') }}"
                                    class="form-control @error('name') is-invalid @enderror" placeholder="Masukkan nama pengguna" required>
                                @error('name')
