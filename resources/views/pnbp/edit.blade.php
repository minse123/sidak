    ...
    <div class="bg-white border-bottom shadow-sm">
        <div class="container-fluid py-4 d-flex flex-column flex-lg-row align-items-lg-center justify-content-between gap-3">
            <div>
                ...
                <h2 class="h2 fw-semibold text-dark mt-2 mb-1">Edit Data PNBP</h2>
                <p class="text-muted mb-0">Perbarui informasi transaksi PNBP yang telah tercatat.</p>
            </div>
                        ...
                        <form action="{{ route('pnbp.update', $pnbp) }}" method="POST" class="d-flex flex-column gap-4">
                            ...
                            <div class="row g-4">
                                <div class="col-md-6">
                                    ...
                                    <input type="text" id="no_dokumen" name="no_dokumen" value="{{ old('no_dokumen', $pnbp->no_dokumen) }}"
                            ...
                            <div>
                                ...
                                <input type="text" id="nama_paket" name="nama_paket" value="{{ old('nama_paket', $pnbp->nama_paket) }}"
                            ...
                            <div class="row g-4">
                                <div class="col-md-6">
                                    ...
                                    <input type="text" id="no_surat_pesanan" name="no_surat_pesanan" value="{{ old('no_surat_pesanan', $pnbp->no_surat_pesanan) }}"
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="text" id="no_dokumen_penerima" name="no_dokumen_penerima" value="{{ old('no_dokumen_penerima', $pnbp->no_dokumen_penerima) }}"
                            ...
                            <div>
                                ...
                                <input type="text" id="termin" name="termin" value="{{ old('termin', $pnbp->termin) }}"
                            ...
                            <div class="row g-4">
                                <div class="col-md-6">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="number" id="nominal_tarif" name="nominal_tarif" value="{{ old('nominal_tarif', $pnbp->nominal_tarif) }}"
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="input-group">
                                        <input type="number" id="persentase_tarif" name="persentase_tarif" value="{{ old('persentase_tarif', $pnbp->persentase_tarif) }}"
                            ...
                            <div class="bg-light p-3 rounded-3">
                                <div class="d-flex justify-content-between align-items-center">
                                    ...
                                    <span id="estimasi_potongan" class="fw-bold text-dark">Rp {{ number_format($pnbp->total_potongan, 0, ',', '.') }}</span>
                                </div>
                            </div>
