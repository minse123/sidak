            ...
            <div class="col-lg-10 col-xl-8">
                <div class="card border-0 shadow-sm">
                    <div class="card-body p-4">
                        <form action="{{ route('bapp.store') }}" method="POST" class="d-flex flex-column gap-4">
                            @csrf
                            ...
                            <div class="row g-4">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="text" id="nik" name="nik" value="{{ old('nik') }}"
                                        ...
                                        placeholder="Masukkan NIK penerima" required>
                                    @error('nik')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div>
                                ...
                                <textarea id="alamat_pekerjaan" name="alamat_pekerjaan" rows="3"
                                    class="form-control @error('alamat_pekerjaan') is-invalid @enderror"
                                    placeholder="Tuliskan alamat lengkap lokasi pekerjaan" required>{{ old('alamat_pekerjaan') }}</textarea>
                            ...
                            <div>
                                ...
                                <textarea id="detail_pekerjaan" name="detail_pekerjaan" rows="4"
                                    class="form-control @error('detail_pekerjaan') is-invalid @enderror"
                                    placeholder="Uraikan lingkup pekerjaan yang tercantum" required>{{ old('detail_pekerjaan') }}</textarea>
                            ...
                            <div class="row g-4">
                                <div class="col-md-6">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="number" id="subtotal" name="subtotal" value="{{ old('subtotal') }}"
                                            class="form-control @error('subtotal') is-invalid @enderror" placeholder="0"
