        ...
        <div class="bg-white border-0 shadow-sm rounded-4">
            <div
                ...
                <div>
                    ...
                    <h1 class="h2 fw-bold text-dark mb-2">Edit Data Surat Pesanan</h1>
                    <p class="text-muted mb-0">
                        Perbarui detail produk dan informasi pemesanan yang telah tersimpan.
                    </p>
                </div>
            ...
            <div class="col-lg-10 col-xl-8">
                <div class="card border-0 shadow-sm">
                    <div class="card-body p-4">
                        <form action="{{ route('surat-pesanan.update', $suratPesanan) }}" method="POST"
                            ...
                            <div class="row g-4">
                                <div class="col-md-6">
                                    ...
                                    <input type="text" id="no_surat_pesanan" name="no_surat_pesanan"
                                        value="{{ old('no_surat_pesanan', $suratPesanan->no_surat_pesanan) }}"
                                        class="form-control @error('no_surat_pesanan') is-invalid @enderror"
                                        placeholder="Masukkan No Surat Pesanan" required>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="text" id="nama_produk" name="nama_produk"
                                        value="{{ old('nama_produk', $suratPesanan->nama_produk) }}"
                            ...
                            <div class="row g-4">
                                <div class="col-md-6">
                                    ...
                                    <input type="text" id="jenis_produk" name="jenis_produk"
                                        value="{{ old('jenis_produk', $suratPesanan->jenis_produk) }}"
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="text" id="kategori" name="kategori"
                                        value="{{ old('kategori', $suratPesanan->kategori) }}"
                            ...
                            <div class="row g-4">
                                <div class="col-md-6">
                                    ...
                                    <input type="number" id="durasi_bulan" name="durasi_bulan"
                                        value="{{ old('durasi_bulan', $suratPesanan->durasi_bulan) }}"
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="text" id="variasi" name="variasi"
                                        value="{{ old('variasi', $suratPesanan->variasi) }}"
                            ...
                            <div class="row g-4">
                                <div class="col-md-6">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="number" id="harga" name="harga"
                                            value="{{ old('harga', $suratPesanan->harga) }}"
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="number" id="jumlah" name="jumlah"
                                        value="{{ old('jumlah', $suratPesanan->jumlah) }}"
                            ...
                            <div class="row g-4">
                                <div class="col-md-6">
                                    ...
                                    <select id="bebas_ppn" name="bebas_ppn"
                                        ...
                                        <option value="0" @selected(old('bebas_ppn', (int) $suratPesanan->bebas_ppn) == 0)>Kena PPN</option>
                                        <option value="1" @selected(old('bebas_ppn', (int) $suratPesanan->bebas_ppn) == 1)>Bebas PPN</option>
                                    </select>
                                    @error('bebas_ppn')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="url" id="url_produk" name="url_produk"
                                        value="{{ old('url_produk', $suratPesanan->url_produk) }}"
                            ...
                            <div class="bg-light p-3 rounded-3">
                                <div class="d-flex justify-content-between align-items-center">
                                    ...
                                    <span id="estimasi_total" class="fw-bold text-dark">Rp
                                        {{ number_format($suratPesanan->harga * $suratPesanan->jumlah, 0, ',', '.') }}</span>
                                </div>
                            </div>
